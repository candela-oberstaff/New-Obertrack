...
import { X, Check, AlertCircle, PlayCircle, HardDrive } from 'lucide-react'
...
export function TutorialFormModal({
  ...
  return (
    <div className={styles['tutorial-modal-overlay']} onClick={onClose}>
      <div className={styles['tutorial-form-modal']} onClick={(e) => e.stopPropagation()}>
        <div className={styles['tutorial-form-header']}>
        ...
        <form onSubmit={onSubmit} className={styles['tutorial-form-body']}>
          ...
          <div className={styles['tutorial-form-actions']}>
            <button type="button" className={styles['tutorial-btn-secondary']} onClick={onClose} disabled={isSaving}>
              Cancelar
            </button>
            <button type="submit" className={styles['tutorial-btn-primary']} disabled={isSaving}>
              {isSaving ? 'Guardando...' : isEditing ? 'Guardar cambios' : 'Crear tutorial'}
            </button>
          </div>
        </form>
      </div>

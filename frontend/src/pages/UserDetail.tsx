...
export default function UserDetail() {
  ...
  const { tracking, isLoading, error, toggleStatus, resetPassword } = useEmployeeTracking(userId)
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.infoGrid}>
        <div className={styles.infoItem}><span>Empresa</span><strong>{user.company_name || '—'}</strong></div>
        <div className={styles.infoItem}><span>Cargo</span><strong>{user.job_title || '—'}</strong></div>

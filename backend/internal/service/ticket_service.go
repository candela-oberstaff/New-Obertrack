...
type TicketService interface {
	...
	// CreateObersuiteTransfer abre el ticket de un chat de WhatsApp que
	// Obersuite transfiere a Customer Success. Idempotente por external_id.
	CreateObersuiteTransfer(in ObersuiteTransferInput) (*ObersuiteTransferResult, error)
